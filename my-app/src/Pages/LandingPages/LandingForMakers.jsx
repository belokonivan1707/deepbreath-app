...
import { ComponentLandingRow, dataForRows } from "../../components/lending-row/lending-row";
import { SliderBlock } from "../../components/slider-block/slider-block";
import Dropdown from "../../components/dropdown/dropdown";
import { dataForLearnMoreItem, LearnMoreItem } from "../../components/learn-more-item/learn-more-item";
...
export function ForMakers() {
  return (
    <Main>
      ...
      <BasketBlock>
        <BasketTitle>
          Hungry Hugger is a discovery and booking platform connecting passionate food and drink makers with local food
          lover’s community.
        </BasketTitle>

        <BasketText>

          We are calling on makers who run unique, authentic, or sustainable businesses to join the community.{" "}
        </BasketText>
      ...
      <MainWrapp>
        ...
        <TextDescription>Be seen consistently and reach new customers.</TextDescription>
      </MainWrapp>
