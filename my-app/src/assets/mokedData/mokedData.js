...
export const dataForRowsCreateShop = [
    {
        title: 'The booking platform that goes beyond and above',
        text: 'We understand that many independent makers who offer experiences are makers at heart. Your secret recipe pastes, sauce and sweets. Your customers want to enjoy it at home too. Our platform provides a simple way to set up your online shop and manage everything in one place.',
        src: 'https://srisovki.com/wp-content/uploads/2021/03/12437.jpg',
        revers: '',
        left: 'left',
        id: 1,
    },
    {
        ...
        text: 'Take the stress out of juggling production, service and management all at once. Our pre-order option means you can stay on top of your orders and prepare for upcoming batches.',
        src: 'https://cdnimg.rg.ru/img/content/182/40/86/Radiosignal_d_850.jpg',
        revers: 'revers',
        left: '',
        id: 2,
    },
    {
        title: 'Connecting your customer both offline and online',
        text: 'Each shop receives a dedicated QR code, giving you a quick and versatile way to connect customers in-store to your Hungry Hugger shop online.',
        src: 'https://srisovki.com/wp-content/uploads/2021/03/12437.jpg',
        revers: '',
        left: 'left',
        id: 3,
    ...
    {
        title: 'Turn analytics into action',
        text: 'Our bespoke analytics will help you find out what’s working and what isn’t. See how many people are viewing your listing and making an order. Along with our customer reviews, these actionable insights will help you improve your experience and drive more orders.',
        src: 'https://static.dw.com/image/18570954_303.jpg',
        revers: 'revers',
        left: '',
        id: 4,
    },
];
export const dataForLearnMoreItemCreateShop = [
    {
        id: 1,
        src: 'https://vraki.net/sites/default/files/test/1_6.jpg',
        linkText: 'Chef’s shop sample ',
        linkSrc: '#',
    },
    {
        id: 2,
        src: 'https://3dnews.ru/assets/external/illustrations/2019/05/23/987980/food2.jpg',
        linkText: 'Taste Master shop sample ',
        linkSrc: '#',
    },
    {
        id: 3,
        src: 'https://www.cossa.ru/upload/iblock/550/fruit-2367029_960_720.jpg',
        linkText: 'Craft Maker shop sample ',
        linkSrc: '#',
    },
];
export const sliderDataCreateShop = {
    info: {
        title: 'One place to manage it all',
