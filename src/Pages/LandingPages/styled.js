...
`
export const ContainerSmallSlick = styled.div`
  width: 450px;
  height: 130px;
  margin: 0 auto;
  ${'' /* border-radius: 15px; */}
...
export const SlickImgWrapp = styled.div`
  ...
  border: none;
`
export const SlickImgWrappSmall = styled.div`
  outline: none;
  border: none;
  ${'' /* width: 122px; */}
  height: 100%;
...
`
export const ImgWrSmall = styled.div`
  ${'' /* width: 10px; */}
  ${'' /* height: 100%; */}
...
`
export const ImgInSlickSliderSmall = styled.img`
  border-radius: 20px;
  height: 124px;
  width: 122px;
  margin:0px;
...
export const LandingRow = styled.section`
  max-width: 1008px;
  display: flex;
  flex-direction: ${(props) => (props.revers === 'revers' ? 'row-reverse' : 'row')};
  padding: 0;
...
export const RightSide = styled.div`
  width: 50%;
`
export const PicturesSmallWrapper = styled.div`
  padding-right:90px;
`
